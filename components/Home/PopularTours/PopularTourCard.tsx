  ...
  return (
    <div className="my-10 max-w-6xl mx-auto px-4">
      ...
      >
        ...
        <div
          key={index}
          className="bg-white border border-purple-200 rounded-xl shadow-md hover:shadow-lg overflow-hidden flex flex-col h-[580px] max-w-[360px] mx-auto"
        >
          ...
          <div className="p-4 flex flex-col justify-between flex-grow">
            <p className="text-[18px] text-blue-900 mb-4 font-medium leading-relaxed">
              {data.content}
            </p>

            {/* Skills */}
            <ul className="text-[17px] text-gray-800 space-y-2 mb-5">
            ...
            <div className="mt-auto pt-4 flex justify-center sm:justify-end">
              <button className="w-full sm:w-[45%] text-md font-ExploreExplore bg-blue-900 text-white py-3 rounded-md hover:bg-blue-950 transition">
                Book now
              </button>
            </div>
